...
public class Night {
    ...
    @JsonProperty("uv_index_raw")
    public Integer getUvIndexRaw() {
        return uvIndexRaw;
    }

    @JsonProperty("uv_index_raw")
    public void setUvIndexRaw(Integer uvIndexRaw) {
    ...
    @JsonProperty("golf_index")
    public Object getGolfIndex() {
        return golfIndex;
    }

    @JsonProperty("golf_index")
    public void setGolfIndex(Object golfIndex) {
